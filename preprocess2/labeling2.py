...
label_base_dir = os.path.normpath(
    r"C:/dataset/109.학습태도 및 성향 관찰 데이터/3.개방데이터/1.데이터/Validation/02.라벨링데이터/VL_20_02"
)
train_base_dir = os.path.normpath(r"C:/dataset/val")
output_pickle_path = os.path.normpath("pickle_labels/valid/20_02.pkl")
