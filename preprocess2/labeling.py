...
label_base_dir = os.path.normpath(
    r"C:/Users/user/Downloads/109.학습태도 및 성향 관찰 데이터/3.개방데이터/1.데이터/Validation/02.라벨링데이터/VL_20_01"
)
train_base_dir = os.path.normpath(r"C:/AIhub_frames/valid")
output_pickle_path = os.path.normpath("pickle_labels/valid/20_01.pkl")
